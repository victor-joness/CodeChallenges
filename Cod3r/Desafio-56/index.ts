...
const checarAnoBissexto2 = (ano:number) => {
    if(ano % 4 == 0){
        if(ano % 100 != 0){
            return true;
        }else{
 ...
 console.log(checarAnoBissexto2(2015));
 console.log(checarAnoBissexto2(2016));
 console.log(checarAnoBissexto2(1500));
 console.log(checarAnoBissexto2(1600));
 console.log(checarAnoBissexto2(1700));
 console.log(checarAnoBissexto2(2000));
 console.log(checarAnoBissexto2(2012));