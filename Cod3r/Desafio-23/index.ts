...
function calcular2(codigo: number, nota1: number, nota2: number, nota3: number){
...
console.log(calcular2(2,3,1,5))

//forma tradicional 

let calcularMedia2 = (codigoAluno: number, nota1 = 0, nota2 = 0, nota3 = 0) => {
