...
const removerPropriedade2 = (objeto, propriedade) => {
...
console.log(removerPropriedade2({a: 1, b: 2}, "b"))
console.log(removerPropriedade2(objeto22, "descricao"));

console.log(Object.is(removerPropriedade2({a: 1, b: 2}, "a"), {a: 1, b: 2}));