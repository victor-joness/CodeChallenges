...
function estaEntre2(numero: number, minimo:number, maximo:number, inclusivo: boolean = false){
    if(inclusivo == true){
...
console.log(estaEntre2(3, 1, 3));
console.log(estaEntre2(3, 150, 3, true));
console.log(estaEntre2(10, 100, 150));
console.log(estaEntre2(10, 100, 250));
console.log(estaEntre2(10, 0, 20));
console.log(estaEntre2(10, 5, 25));