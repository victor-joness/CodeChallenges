...
3**2 + 4**2 = 9 + 16 = 25 = 5**2.
Dado um inteiro de entrada N, encontre todos os trigêmeos pitagóricos para os quais a + b + c = N.

Por exemplo, com N = 1000, há exatamente uma trinca pitagórica para a qual a + b + c = 1000: {200, 375, 425}.
*/
